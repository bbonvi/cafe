...
function recalc() {
  ...
  // const scrollElement = isEdge ? document.body : document.documentElement;
  const scrollTop = document.body.scrollTop || document.documentElement.scrollTop;
  const needTop = scrollTop > 300;
  const needBottom = el.scrollHeight - scrollTop  > el.clientHeight + 300;
