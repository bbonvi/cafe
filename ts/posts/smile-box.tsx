...
const thingSmiles = new Set(
  ...
  confetti hat_green cocktail heart heart2 heart3 heart4 cigarette cigarette2 snowman scarf2 sweater fire
  tophat wine coffee cola chips goose nogoose gun gun2 karandash knife ovsyanka ramyun umbrella chocolate
  space mandarin
`
    .trim()
    .split(/\s+/),
